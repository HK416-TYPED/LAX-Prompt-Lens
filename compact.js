...
async function runManualTextPipeline({ endpoint, apiKey }) {
  ...
  const meta = `MANUAL / ${result.characterPrompts.length} CHARACTER REGIONS`;
  await chrome.storage.session.set({
